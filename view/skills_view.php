...
?>
	<h2 class="id-page">COMPETENCES</h2>
			<div class="row text-center">
				<div class="col-md shadow mr-3" id="logo-skills">
				...
				<div class="col-md shadow mr-3" id="being">
					<h3>Savoir-être</h3>
					<ul>
						<li>Autonome</li>
				...
				<div class="col-md shadow mr-3" id="doing">
					<h3>Savoir-faire</h3>
					<ul>
						<li>Accueillir</li>
				...
				<div class="col-md shadow mr-3" id="speaking">
					<h3>Langues</h3>
					<ul>
						<li><b>Anglais</b> :</li>
						<li>Niveau B2</li>
				...
				<div class="col-md shadow" id="hobbies">
					<h3>Loisirs</h3>
					<ul>
						<li>Cinéma</li>
						<li>Couture</li>
